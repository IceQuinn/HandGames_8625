...
#define ASCII_NUM 96
#define ASCII_EACH_SIZE 16
/* 
 * ASCII 8_16 字模库.去除了前32个控制字符。
 * 扫描方式：由左到右，由上到下。宽度按字节对齐。
 * 存储方式: 低位在前。
*/
const unsigned char ASCII_8_16[ASCII_NUM][ASCII_EACH_SIZE]={
...
uint8_t GetFontASCII_8_16(uint8_t code1, uint8_t *pBuff)
{
